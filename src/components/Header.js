...
import { Icon, search, chartBar } from '@wordpress/icons';

/**
 * Header component for Search Query Tracker
 */
const Header = ({ onSettingsClick, currentView, onViewChange }) => {
    return (
        <div className="bg-white border-b border-gray-200">
            <div className="p-6 flex justify-between items-center">
                <div className="flex gap-4 items-center">
                    ...
                    <h1 className="!text-3xl font-bold leading-none !p-0">{__('Search Query Tracker', 'search-query-tracker')}</h1>
                </div>
                ...
                >
                    {__('Settings', 'search-query-tracker')}
                </Button>
            </div>
            ...
            <div className="px-6 flex gap-2 border-t border-gray-200">
                ...
                >
                    <Icon icon={search} />
                    {__('Search Queries', 'search-query-tracker')}
                </button>
                ...
                >
                    <Icon icon={chartBar} />
                    {__('Analytics', 'search-query-tracker')}
                </button>
            </div>
        </div>
    );
