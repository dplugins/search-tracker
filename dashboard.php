...
function sqt_enqueue_admin_scripts($hook) {
    ...
    wp_enqueue_script('sqt-admin', plugin_dir_url(SQT_PLUGIN_FILE) . 'admin.js', ['jquery'], '1.0', true);
    
    // Add some basic styling
    wp_enqueue_style('sqt-admin-style', plugin_dir_url(SQT_PLUGIN_FILE) . 'admin.css', [], '1.0');
}
